...
import 'package:right_wash/src/view/verify_location/verify_location.dart';
import 'package:right_wash/src/view/washing_frequency/washing_frequency_view.dart';
...
class Routes {
  ...
  GoRouter routes = GoRouter(
    ...
    initialLocation: "/verify-location",
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
        path: "/washing-frequency",
        pageBuilder: (context, state) {
          return BaseFunctions.instance.animatedRouting(
            state: state,
            route: const WashingFrequencyView(),
          );
        },
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) {
          return BaseFunctions.instance.animatedRouting(
            state: state,
            route: const VerifyLocationView(),
          );
        },
      ),
    ],
