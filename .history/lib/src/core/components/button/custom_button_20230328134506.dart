        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: widget.isBorder == true ? colors.red : colors.white),
              boxShadow: const [
                BoxShadow(
                  offset: Offset(0, 0),
            ...
            child: widget.isFirstIcon!
                    ...
                    children: [
                      widget.path != null
                          ? SvgPicture.asset(
                              widget.path!.toSvg,
                              height: 2.5.h,
                              color: widget.pathColor ?? colors.white,
                            )
                          : widget.icon != null
                              ? Icon(
                                  widget.icon,
                ...
                : Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      widget.pathFirst != null
                          ? SvgPicture.asset(
                              widget.pathFirst!.toSvg,
                              height: 2.5.h,
                              color: widget.pathFirstColor ?? colors.white,
                            )
                          : const SizedBox.shrink(),
                      2.w.pw,
                      CustomText(
